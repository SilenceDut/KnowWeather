...
public class ResourceProvider {
    ...
    private static final int[] NOTIFICATION_THEMES_NAMES = {R.string.core_follow_system, R.string.core_pure_white};
    ...
    private static final int[] ICONS_ID = {R.mipmap.core_weather_clouds, R.mipmap.core_weather_sunny, R.mipmap.core_weather_few_clouds, R.mipmap.core_weather_big_rain, R.mipmap.core_weather_rain, R.mipmap.core_weather_snow, R.mipmap.core_weather_wind, R.mipmap.core_weather_haze, R.mipmap.core_weather_rain_snow};
